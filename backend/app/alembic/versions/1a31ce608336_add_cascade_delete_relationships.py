...
def upgrade():
    ...
    op.alter_column('beverage', 'owner_id',
               existing_type=sa.UUID(),
               nullable=False)
    op.drop_constraint('beverage_owner_id_fkey', 'beverage', type_='foreignkey')
    op.create_foreign_key(None, 'beverage', 'user', ['owner_id'], ['id'], ondelete='CASCADE')
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint(None, 'beverage', type_='foreignkey')
